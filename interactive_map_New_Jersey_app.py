...
def main():
    ...
    faculty_selected = st.sidebar.selectbox("Faculty:", options=['All'] + faculty_list, key='faculty_selected')
    focus_selected = st.sidebar.selectbox("Focus Area:", options=['All'] + focus_area_list, key='focus_selected')
    activity_selected = st.sidebar.selectbox("Activity:", options=['All'] + activity_list, key='activity_selected')
    campus_selected = st.sidebar.selectbox("Campus Partner:", options=['All'] + campus_partner_list, key='campus_selected')
